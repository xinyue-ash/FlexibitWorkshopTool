...
// a supper nice arduino simulator
#include <Servo.h>
...
void setup()
{
  ...
  servo2.StartNewSequence();
  servo2.setAnglePeriod(170, 4000); // Move to 180 degrees in 4000 ms
  servo2.setAnglePeriod(20, 4000);  // Move back to 0 degrees in 4000 ms
  servo2.SetRepeats(3);             // Perform the sequence 10 times

  servo2.StartNewSequence();
  servo2.setAnglePeriod(90, 500); // Move to 180 degrees in 4000 ms
  servo2.setAnglePeriod(20, 500); // Move back to 0 degrees in 4000 ms
  servo2.SetRepeats(3);

  servo2.StartNewSequence();
  servo2.setAngleSpeed(0, 5);  // Move to 0 degrees with speed 30
  servo2.setAngleSpeed(50, 5); // Move to 50 degrees with speed 30
  servo2.SetRepeats(3);        // Perform the sequence 10 times

  servo2.StartNewSequence();
  servo2.setAnglePeriod(20, 500);
  servo2.setAngleSpeed(50, 5); // Move to 50 degrees with speed 30
  servo2.SetRepeats(3);        // Perform the sequence 10 times
